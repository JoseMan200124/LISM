...
import type { UserLaboratory } from "@/lib/lab-membership";
...
// La membresía vive en lib/lab-membership.ts: la comparten el puente de Dilo y
// el gateway de integraciones. Se reexporta para no romper a quien ya la
// importaba desde aquí.
export { listUserLaboratories, type UserLaboratory } from "@/lib/lab-membership";
