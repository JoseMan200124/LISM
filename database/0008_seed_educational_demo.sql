...
VALUES
  ('00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000011', 'RES-2026-001', '00000000-0000-0000-0000-000000010751', 'INVENTORY_ITEM', '00000000-0000-0000-0000-000000000411', 30, 'mL', now() + interval '1 day' + time '09:30:00', '00000000-0000-0000-0000-000000000102', 'APPROVED'),
  ('00000000-0000-0000-0000-000000000802', '00000000-0000-0000-0000-000000000011', 'RES-2026-002', '00000000-0000-0000-0000-000000010751', 'INVENTORY_ITEM', '00000000-0000-0000-0000-000000000412', 30, 'mL', now() + interval '1 day' + time '09:30:00', '00000000-0000-0000-0000-000000000102', 'APPROVED'),
  ('00000000-0000-0000-0000-000000000803', '00000000-0000-0000-0000-000000000011', 'RES-2026-003', '00000000-0000-0000-0000-000000010751', 'INVENTORY_ITEM', '00000000-0000-0000-0000-000000000413', 30, 'mL', now() + interval '1 day' + time '09:30:00', '00000000-0000-0000-0000-000000000102', 'READY'),
  ('00000000-0000-0000-0000-000000000804', '00000000-0000-0000-0000-000000000011', 'RES-2026-004', '00000000-0000-0000-0000-000000010751', 'INVENTORY_ITEM', '00000000-0000-0000-0000-000000000421', 20, 'unidades', now() + interval '1 day' + time '09:30:00', '00000000-0000-0000-0000-000000000102', 'READY'),
  ('00000000-0000-0000-0000-000000000805', '00000000-0000-0000-0000-000000000011', 'RES-2026-005', '00000000-0000-0000-0000-000000010751', 'EQUIPMENT', '00000000-0000-0000-0000-000000000501', 6, 'microscopios', now() + interval '1 day' + time '09:30:00', '00000000-0000-0000-0000-000000000102', 'APPROVED'),
  ('00000000-0000-0000-0000-000000000806', '00000000-0000-0000-0000-000000000011', 'RES-2026-006', '00000000-0000-0000-0000-000000010752', 'EQUIPMENT', '00000000-0000-0000-0000-000000000501', 12, 'microscopios', now() + interval '4 days' + time '13:30:00', '00000000-0000-0000-0000-000000000103', 'PENDING'),
  ('00000000-0000-0000-0000-000000000807', '00000000-0000-0000-0000-000000000011', 'RES-2026-007', '00000000-0000-0000-0000-000000010752', 'INVENTORY_ITEM', '00000000-0000-0000-0000-000000000434', 4, 'frascos', now() + interval '4 days' + time '13:30:00', '00000000-0000-0000-0000-000000000103', 'PENDING'),
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000907', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000011', 'WARNING', 'OPEN', 'EDUCATIONAL_PRACTICE', '00000000-0000-0000-0000-000000010751', 'Práctica de tinción lista para mañana', 'PRA-2026-021 está confirmada para mañana a las 10:00. Notificar a los estudiantes del grupo MIC-I-2026-A.', now() - interval '1 hour'),
...
VALUES
  ('00000000-0000-0000-0000-000000000a01', '00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000010751', '00000000-0000-0000-0000-000000000601', 'Recordatorio: práctica de tinción de Gram mañana', 'Mañana tienes práctica de tinción de Gram a las 10:00 h en el Laboratorio A. Revisa la guía antes de llegar. El equipo estará disponible desde las 09:45.', 'STUDENTS', now(), '00000000-0000-0000-0000-000000000102'),
  ('00000000-0000-0000-0000-000000000a02', '00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000010751', '00000000-0000-0000-0000-000000000601', 'Instrucción previa: guía de tinción de Gram', 'El docente publicó la guía de tinción de Gram. Descárgala antes de la clase. Asegúrate de traer tu bitácora y seguir el protocolo de seguridad.', 'STUDENTS', now() - interval '6 hours', '00000000-0000-0000-0000-000000000102'),
  ('00000000-0000-0000-0000-000000000a03', '00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000010752', '00000000-0000-0000-0000-000000000602', 'Práctica de microscopio: cambio de hora', 'La práctica PRA-2026-022 (Verificación de microscopio) se realizará a las 14:00 en el Laboratorio B, no en el A, por mantenimiento en progreso.', 'STUDENTS', now() - interval '1 day', '00000000-0000-0000-0000-000000000103'),
